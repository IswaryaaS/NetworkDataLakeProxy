...
exports.getAppInformation = async function() {
    if (!appInformation) {
        ...
        try {
            ...
            appInformation["application-name"] = "NetworkDataLakeProxy";
            appInformation["release-number"] = "1.0.1";
        }
    }
...
exports.createRequestHeader = function (operationKey) {
    return new RequestHeader("NetworkDataLakeProxy", "NetworkDataLakeProxy", undefined, "1", undefined, operationKey);
}

exports.buildRequestTargetPath = function (controllerProtocol, controllerAddress, controllerPort) {
    let addressPart;
